...
namespace SpiceRight.Services
{
	public class OfflineDataStore : IDataStore
	{
		...
		{
			var json = ResourceLoader.GetEmbeddedResourceString(Assembly.Load(new AssemblyName("SpiceRight")), "stores.json");
		...
		public async Task<Feedback> AddFeedbackAsync(Feedback feedback)
		{
			...
			var eamilTask = CrossMessaging.Current.EmailMessenger;
			if (eamilTask.CanSendEmail)
			{
				eamilTask.SendEmail("james.montemagno@xamarin.com", "My Shop Feedback", feedback.ToString());
			}
